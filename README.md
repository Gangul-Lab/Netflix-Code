...
pipeline {
    ...
    stages {
        ...
        stage('Checkout from Git') {
            steps {
                git branch: 'main', url: 'https://github.com/Gangul-Lab/Netflix-Code.git'
            }
        }
        ...
        stage("Docker Build Image"){
            steps{
                ...
                sh "docker build --build-arg API_KEY=b875922fce42e1ee3b0d95259632ed9c -t netflix ."
            }
        }
        stage("TRIVY"){
            steps{
        ...
        stage("Docker Push"){
            steps{
                script {
                    ...
                    sh "docker tag netflix gangul123/netflix:latest "
                    sh "docker push gangul123/netflix:latest"
                    }
                }
            }
        }
